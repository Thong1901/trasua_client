...
export const config = {
  // API Base URL
  API_BASE_URL: import.meta.env.VITE_API_BASE_URL || 'https://167.71.202.33/api',

  // Server Base URL (for images and static files)
  SERVER_BASE_URL: import.meta.env.VITE_SERVER_BASE_URL || 'https://167.71.202.33',

  // Local development URLs
  LOCAL_API_URL: 'https://167.71.202.33/api',
  LOCAL_SERVER_URL: 'https://167.71.202.33',
